...
namespace SistemaTechWeb.UI.Reportes {
    ...
    public partial class ProyectoDataSet : global::System.Data.DataSet {
        ...
        public partial class UsuariosDataTable : global::System.Data.TypedTableBase<UsuariosRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public UsuariosRow AddUsuariosRow(string Nombres, string NombreUsuario, string Clave, string ConfirmarClave) {
            ...
            private void InitClass() {
                ...
                this.columnNombreUsuario.MaxLength = 80;
                this.columnClave.MaxLength = 40;
                this.columnConfirmarClave.MaxLength = 40;
            }
...
namespace SistemaTechWeb.UI.Reportes.ProyectoDataSetTableAdapters {
    ...
    public partial class UsuariosTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Usuarios] ([Nombres], [NombreUsuario], [Clave], [ConfirmarClav" +
                "e]) VALUES (@Nombres, @NombreUsuario, @Clave, @ConfirmarClave)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Usuarios] SET [Nombres] = @Nombres, [NombreUsuario] = @NombreUsuari" +
                "o, [Clave] = @Clave, [ConfirmarClave] = @ConfirmarClave WHERE (([UsuarioId] = @O" +
                "riginal_UsuarioId))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT UsuarioId, Nombres, NombreUsuario, Clave, ConfirmarClave FROM dbo.Usuarios" +
                "";
        ...
        public virtual int Insert(string Nombres, string NombreUsuario, string Clave, string ConfirmarClave) {
            if ((Nombres == null)) {
        ...
        public virtual int Update(string Nombres, string NombreUsuario, string Clave, string ConfirmarClave, int Original_UsuarioId) {
            if ((Nombres == null)) {
